...
//
// Fixed : Add event namespace , chokchai.puttan@gmail.com
(function($){
    ...
    $.extend($.fn, {
        ...
        rightClick: function(handler) {
            $(this).each( function() {
                $(this).bind('mousedown.rClick', function(e) {
                    var evt = e;
                    $(this).bind('mouseup.rClick', function() {
                        $(this).unbind('mouseup.rClick');
                        if( evt.button == 2 ) {
        ...
        rightMouseUp: function(handler) {
            $(this).each( function() {
                $(this).bind('mouseup.rClick', function(e) {
                    if( e.button == 2 ) {
                        handler.call( $(this), e );
                        return false;
                    } else {
