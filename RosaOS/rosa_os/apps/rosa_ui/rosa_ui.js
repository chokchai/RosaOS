(function( window, $, undefined ){
    ...
    ui.dialog = {
        ...
        run : function(){
            ...
            $R.isDialog = true;
            var dialog = function(){
                //destroy original dialog element
                var _return = self.$ele.dialog.apply(self.$ele, arguments);
                if( arguments[0] == 'destroy' ){
                    //when destroy we need to destroy anything...
                    self.$ele.remove();
                }
                return _return;
            };
    ...
    ui.fn.extend({
            ...
            return $(this).each(function(){
                ...
                if( $.isPlainObject(_opt) ){
                    ...
                    .bind('mouseleave.rosaDrag',function(e){
                        ...
                        //stop bubble to behide element
                        e.stopPropagation();
                    })
                    .bind('mouseenter.rosaDrag',function(e){
                        $this.data('drop','inner');
                        //stop bubble to behide element
                        e.stopPropagation();
                    });
                ...
                var upload_obj = $(this).upload({
                    ...
                    onComplete: function( response ) {
                        ...
                        if($.isFunction(func)){
                            ...
                            if(response.error){
                                R.alert(response.reason, 'Upload File');
                            }
        ...
        rosaUnselect : function(){
            return $(this).each(function(){
                ...
                //register to unselected list
                if($.inArray(this, window.R.ui.unselectedList) === -1){
                    window.R.ui.unselectedList.push(this);
                }
            });
        }
    ...
    //bind unselected event to window
    $(window).bind('mouseup.unselected',function(){
        $.each( window.R.ui.unselectedList, function(){
